        ...
        for cache_file in CACHE_DIR.iterdir():
            if cache_file.is_file():
                ...
                if cache_type is None:
                    ...
                    should_remove = (
                        cache_file.suffix in [PLAYLIST_CACHE_EXT, VIDEOS_CACHE_EXT, VIDEOS_WITH_DURATIONS_CACHE_EXT] or
                        cache_file.name.endswith(('.playlist.json', '.videos.json', '.videos_durations.json'))
                    )
                else:
                    ...
                    if cache_type == "playlist" and cache_file.name.endswith(PLAYLIST_CACHE_EXT):
                        ...
                        should_remove = True
                    elif cache_type == "videos_durations" and cache_file.name.endswith(VIDEOS_WITH_DURATIONS_CACHE_EXT):
                        should_remove = True
